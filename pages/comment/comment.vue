	...
	<view style="padding: 20rpx;">
		<view class="box" style="padding: 50rpx 20rpx;">
			<uni-forms :modelValue="form" :rules="rules" ref="formRef" label-width="140rpx" label-align="right">
				<uni-forms-item label="订单编号" style="display: flex;">
					<navigator :url="'/pages/detail/detail?orderId=' + orders.id" style="padding: 0 20rpx; color: #FFD700;">{{ orders.orderNo }}</navigator>
				</uni-forms-item>
