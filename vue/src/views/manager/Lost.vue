  ...
  <div>
    ...
    <div class="table">
      <el-table :data="tableData" strip @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="title" label="失物招领标题"></el-table-column>
        <el-table-column prop="content" label="实物招领内容"></el-table-column>
        <el-table-column prop="userId" label="发布人id"></el-table-column>
        <el-table-column prop="username" label="发布人姓名"></el-table-column>
        <el-table-column prop="acceptId" label="领取人id"></el-table-column>
        <el-table-column prop="addressId" label="取货地址id"></el-table-column>
        <el-table-column prop="targetId" label="收货地址id"></el-table-column>
