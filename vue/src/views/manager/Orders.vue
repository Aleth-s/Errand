<template>
  <div>
    <div class="search">
      <el-input placeholder="请输入订单编号查询查询" style="width: 200px" v-model="orderNo  "></el-input>
    ...
    <div class="table">
      <el-table :data="tableData" stripe  @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="descr" label="订单描述"></el-table-column>
        ...
        <el-table-column prop="acceptName" label="接收人"></el-table-column>
